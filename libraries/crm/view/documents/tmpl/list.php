...
?>
    <thead>
        <th><div class="sort_order"><a href="javascript:void(0);"class="d.type" onclick="sortTable('d.type',this)"><?php echo CRMText::_('COBALT_DOCUMENT_TYPE'); ?></a></div></th>
        <th><div class="sort_order"><a href="javascript:void(0);"class="d.filename" onclick="sortTable('d.filename',this)"><?php echo CRMText::_('COBALT_DOCUMENT_NAME'); ?></a></div></th>
        <th><?php echo CRMText::_('COBALT_DOCUMENT_ASSOCIATION'); ?></th>
        <th><div class="sort_order"><a href="javascript:void(0);"class="p.last_name" onclick="sortTable('p.last_name',this)"><?php echo CRMText::_('COBALT_DOCUMENT_OWNER'); ?></a></div></th>
        <th><?php echo CRMText::_('COBALT_DOCUMENT_SIZE'); ?></th>
        <th><div class="sort_order"><a href="javascript:void(0);"class="d.created" onclick="sortTable('d.created',this)"><?php echo CRMText::_('COBALT_DOCUMENT_UPLOADED'); ?></a></div></th>
    </thead>
    ...
    if ( count($this->documents) > 0 ) {
        foreach ($this->documents as $key => $document) {
            ...
            echo '<tr class="document_'.$key.'" id="document_row_'.$document['id'].'" class="cobalt_row_'.$k.'">';
                ...
                echo '<li><a href="javascript:void(0);" class="document_delete" id="delete_'.$document['id'].'"><i class="icon-trash"></i> '.CRMText::_('COBALT_DELETE').'</a></li>';
                echo '</ul>';
                echo '</div></td>';
