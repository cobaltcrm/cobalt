...
<form id="edit-form" action="<?php echo JRoute::_('index.php?controller=editGoal'); ?>" method="post" onsubmit="return save(this);">
    <div id="goal_edit">
        <ul class="unstyled">
             <li>
                    <legend><b><?php echo ucwords(CRMText::_('COBALT_GOAL_STEP_ONE')); ?></b></legend>
                    <?php
                    ...
                    <?php switch ($this->type) {
                        case "win_cash": ?>
                                <?php echo CRMText::_('COBALT_I_WANT'); ?>
                                    <?php echo $user_html; ?>
                                    <?php echo CRMText::_('COBALT_TO_SELL'); ?>
                                    <input class="required inputbox" type="text" value="" placeholder="0" name="amount" />
                                    <?php echo CRMText::_('COBALT_OF_NEW_BUSINESS'); ?>
                                   <?php echo $date_html; ?>
                                <?php
                            break;
                        case "win_deals": ?>
                        ...
                        case "move_deals": ?>
                                <?php echo CRMText::_('COBALT_I_WANT'); ?>
                                    <?php echo $user_html; ?>
                                    <?php echo CRMText::_('COBALT_TO_MOVE'); ?>
                                    ...
                                    <?php echo CRMText::_('COBALT_STAGE'); ?>
                                    <?php echo $date_html; ?>
                                <?php
                            break;
                        case "complete_tasks": ?>
                                 <?php echo CRMText::_('COBALT_I_WANT'); ?>
                                    <?php echo $user_html; ?>
                                    <?php echo CRMText::_('COBALT_TO_COMPLETE'); ?>
                                    <input class="inputbox required" type="text" value="" placeholder="0" name="amount" />
                        ...
                        case "write_notes": ?>
                             <?php echo CRMText::_('COBALT_I_WANT'); ?>
                                    <?php echo $user_html; ?>
                                    <?php echo CRMText::_('COBALT_TO_WRITE'); ?>
                                    <input class="inputbox required" type="text" value="" placeholder="0" name="amount" />
                        ...
                        case "create_deals": ?>
                             <?php echo CRMText::_('COBALT_I_WANT'); ?>
                                    <?php echo $user_html; ?>
                                    <?php echo CRMText::_('COBALT_TO_CREATE'); ?>
                                    <input class="inputbox required" type="text" value="" placeholder="0" name="amount" />
                                    <?php echo CRMText::_('COBALT_DEALS'); ?>
                                    <?php echo $date_html; ?>
                            <?php
                            break;
                    }?>
            ...
            <li id="date_selection_area" style="display:none;">
                <div id="date_selection_area_template">
                    <legend><b><?php echo CRMText::_('COBALT_SET_YOUR_DATE'); ?></b></legend>
                    <ul class="unstyled">
                        <li>
                            <label><?php echo CRMText::_('COBALT_START_DATE'); ?></label>
                        ...
                        <li>
                            <label><?php echo CRMText::_('COBALT_END_DATE'); ?></label>
                            <span class="input-append">
            ...
            <li>
                <legend><b><?php echo ucwords(CRMText::_('COBALT_GOAL_STEP_TWO')); ?></b></legend>
                <input type="text" name="name" class="inputbox required" value="" />
            </li>
            <li>
                <legend><b><?php echo ucwords(CRMText::_('COBALT_GOAL_STEP_THREE')); ?></b></legend>
                    <ul class="unstyled">
