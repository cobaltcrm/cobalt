...
<?php echo $this->menu; ?>
<h2><?php echo CRMText::_('COBALT_SELECT_CUSTOM_COLUMNS'); ?></h2>
<p><?php echo CRMText::_('COBALT_CUSTOM_COLUMNS_MESSAGE'); ?></p>
...
<div id="custom_field_holders">
    <ul class="holders">
        ...
        <?php for ($i=0; $i<10-$field_count; $i++) { ?>
            <li class="holder"><?php echo CRMText::_('COBALT_DRAG_FIELD_HERE'); ?></li>
        <?php } ?>
    </ul>
</div>
<form action="index.php?controller=editReport" onsubmit="return validateCustomForm(this);" method="post">
    <div class="custom_report_inputs">
        <p><?php echo CRMText::_('COBALT_NAME_REPORT'); ?>:</p><input class="inputbox required" type="text" name="name" value="<?php if ( array_key_exists('report',$this) ) echo $this->report[0]['name']; ?>">
        <p><input class="btn btn-success" type="submit" value="<?php echo CRMText::_('COBALT_SAVE'); ?>"> - <?php echo CRMText::_('COBALT_OR'); ?> - <a href="javascript:void(0);" onclick="window.history.back()"><?php echo CRMText::_('COBALT_CANCEL_BUTTON'); ?></a></p>
    </div>
    <div id="post">
