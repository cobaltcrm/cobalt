...
<div class="page-header">
    <h1><?php echo ucwords(CRMText::_('COBALT_DEAL_MILESTONE_REPORT')); ?></h1>
</div>
<?php echo $this->menu; ?>
            ...
            <td>
                <select class="inputbox filter_input" name="owner_id">
                    ...
                    <?php if ( CobaltHelperUsers::getRole() != "basic" ) { ?>
                        ...
                        <optgroup label="<?php echo CRMText::_('COBALT_TEAM'); ?>" class="team">
                            <?php echo JHtml::_('select.options', $this->team_names, 'value', 'text', $user_filter, true); ?>
                        </optgroup>
                        <optgroup label="<?php echo CRMText::_('COBALT_MEMBERS'); ?>" class="member">
                            <option value="<?php echo CobaltHelperUsers::getUserId(); ?>"><?php echo CRMText::_('COBALT_ME'); ?></option>
