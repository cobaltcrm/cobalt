...
class CobaltViewReportsHtml extends JViewHtml
{
    ...
    function _display_custom_report(){
        ...
        $custom_report_header = CobaltHelperView::getView('reports','custom_report_header','phtml',array('report_data'=>$this->report_data,'report'=>$this->report,'state'=>$state));
        $custom_report_list = CobaltHelperView::getView('reports','custom_report_filter','phtml',array('report_data'=>$this->report_data,'report'=>$this->report,'state'=>$state));
        $custom_report_footer = CobaltHelperView::getView('reports','custom_report_footer','phtml');
    ...
    function _display_notes(){
        ...
        $this->notes_list = CobaltHelperView::getView('reports','notes_filter','phtml', array('note_entries'=>$note_entries));

        $state = $noteModel->getState();
        $notes_header = CobaltHelperView::getView('reports','notes_header','phtml', array('note_entries'=>$note_entries,'state'=>$state));
        $notes_footer = CobaltHelperView::getView('reports','notes_footer','phtml');
        $notes_header->team_names   = CobaltHelperDropdown::getTeamNames();
        $notes_header->user_names   = CobaltHelperDropdown::getUserNames();
    ...
    function _display_deal_milestones(){
        ...
        //list view
        $this->deal_milestone_list = CobaltHelperView::getView('reports','deal_milestones_filter','phtml', array('deals'=>$deals));
        $this->deals = $deals;
    }
    ...
    function _display_source_report(){
        ...
        $modified_dates = CobaltHelperDeal::getModified();
         ...
         //list view
        $source_report_header  = CobaltHelperView::getView('reports','source_report_header','phtml', array('state'=>$state,'reports'=>$reports));
        $source_report_list    = CobaltHelperView::getView('reports','source_report_filter','phtml', array('reports'=>$reports));
        $source_report_footer  = CobaltHelperView::getView('reports','source_report_footer','phtml');
        ...
        $source_report_header->team_names = CobaltHelperDropdown::getTeamNames();
        $source_report_header->user_names = CobaltHelperDropdown::getUserNames();
    ...
    function _display_sales_pipeline(){
        ...
        //list view
        $sales_pipeline_header  = CobaltHelperView::getView('reports','sales_pipeline_header','phtml', array('state'=>$state,'reports'=>$reports));
        $sales_pipeline_list    = CobaltHelperView::getView('reports','sales_pipeline_filter','phtml', array('reports'=>$reports));
        $sales_pipeline_footer  = CobaltHelperView::getView('reports','sales_pipeline_footer','phtml');
        ...
        $sales_pipeline_header->team_names = CobaltHelperDropdown::getTeamNames();
        $sales_pipeline_header->user_names = CobaltHelperDropdown::getUserNames();
