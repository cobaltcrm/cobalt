<div class="infoContainer">
    ...
    <div id="transcript_list">
        <table id="transcripts_table" class="com_cobalt_table">
            <thead>
                <tr>
                    <th><?php echo CRMText::_('COBALT_ROOM'); ?></th>
                    <th><?php echo CRMText::_('COBALT_DATE'); ?></th>
                    <th><?php echo CRMText::_('COBALT_VIEW'); ?></th>
                </tr>
            </thead>
            <tbody id="transcript_entries">
                <?php
                     $transcript_list_view = CobaltHelperView::getView('banter','transcripts','phtml',array(array('ref'=>'transcripts','data'=>$this->transcripts)));
