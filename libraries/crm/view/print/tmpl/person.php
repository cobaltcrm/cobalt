...
<div class="rightColumn">
	...
	<div class="infoContainer" id="twitter_dock">
		<h2><?php echo ucwords(CRMText::_('COBALT_RECENT_TWEETS')); ?></h2>
	...
	<div class="columncontainer">
		<div class="threecolumn">
			<div class="small_info first">
				<?php echo ucwords(CRMText::_('COBALT_PERSON_TOTAL')); ?>
			...
			<div class="cobaltRow">
				<div class="cobaltField"><?php echo CRMText::_('COBALT_OWNER'); ?>:</div>
...
<h2 class="dotted"><?php echo ucwords(CRMText::_('COBALT_EDIT_DEALS')); ?></h2>

	<div class="large_info">
		<table class="com_cobalt_table" id="deal_list">
			<th><?php echo ucwords(CRMText::_('COBALT_DEAL_NAME')); ?></th>
			<th><?php echo ucwords(CRMText::_('COBALT_DEAL_OWNER')); ?></th>
			<th class="right"><?php echo ucwords(CRMText::_('COBALT_DEAL_AMOUNT')); ?></th>
			<?php
...
<h2 class="dotted"><?php echo CRMText::_('COBALT_EDIT_NOTES'); ?></h2>
