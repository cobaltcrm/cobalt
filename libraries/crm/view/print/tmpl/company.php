...
<div class="rightColumn">
    <div class="infoContainer" id="details">
        <h2><?php echo ucwords(CRMText::_('COBALT_COMPANY_DETAILS')); ?></h2>
        <div class="infoBlock">
            <div class="infoLabel">
    ...
    <div class="columncontainer">
        <div class="threecolumn">
            <div class="small_info first">
                <?php echo ucwords(CRMText::_('COBALT_COMPANY_TOTAL')); ?></td>
...
<h2><?php echo ucwords(CRMText::_('COBALT_EDIT_DEALS')); ?></h2>
    ...
    <div class="large_info">
        <table class="com_cobalt_table" id="deal_list">
            ...
            <th><?php echo CRMText::_('COBALT_DEAL_OWNER'); ?></th>
            <th><span class="amount"><?php echo CRMText::_('COBALT_DEAL_AMOUNT'); ?></span></th>
            <?php
