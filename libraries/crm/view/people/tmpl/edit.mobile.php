...
<div data-role='header' data-theme='b'>
	<h1><?php echo CRMText::_('COBALT_ADD_PERSON'); ?></h1>
...
<div data-role="content">
	...
	<form id="edit_form" method="POST" action="<?php echo 'index.php?controller=save&model=people&return=people'; ?>" onsubmit="return save(this)" >
			...
			<div class="cobaltRow">
				<div class="cobaltField"><?php echo CRMText::_('COBALT_PERSON_COMPANY'); ?></div>
			...
			<div class="cobaltRow">
				<div class="cobaltField"><?php echo CRMText::_('COBALT_PERSON_SOURCE'); ?></div>
				<div class="cobaltValue">
		...
		?>
		<input type="submit" name="submit"  value="<?php echo CRMText::_('COBALT_SUBMIT'); ?>" />
	</form>
</div>