...
<div data-remote="index.php?view=people&layout=edit&format=raw&tmpl=component&id=<?php echo $person['id']; ?>" class="modal hide fade" id="personModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel"><?php echo ucwords(CRMText::_('COBALT_EDIT_PERSON')); ?></h3>
    </div>
		...
		<div class="page-header">
			...
			<div class="btn-group pull-right">
			    ...
			    <ul class="dropdown-menu">
			    	<li><a role="button" href="#personModal" data-toggle="modal"><?php echo CRMText::_('COBALT_EDIT_BUTTON'); ?></a></li>
			    	<li><a href="javascript:void(0);" onclick="addDeal('person_id=<?php echo $person['id']; ?>')"><?php echo CRMText::_('COBALT_ASSOCIATE_TO_DEAL'); ?></a></li>
					<?php if ( $person['owner_id'] == CobaltHelperUsers::getUserId() ){ ?>
						<li><a href="javascript:void(0);" onclick="shareItemDialog();" ><?php echo CRMText::_('COBALT_SHARE'); ?></a></li>
					<?php } ?>
					<li>
						<?php if ( CobaltHelperUsers::canDelete() || $person['owner_id'] == CobaltHelperUsers::getUserId() ) { ?>
							<a href="index.php?controller=trash&item_id=<?php echo $person['id']; ?>&item_type=people&page_redirect=people" onclick="deleteProfileItem(this)"><?php echo CRMText::_('COBALT_DELETE_CONTACT'); ?></a>
						<?php } ?>
					</li>
					<li>
						<a href="index.php?view=print&item_id=<?php echo $person['id']; ?>&layout=person&model=people" target="_blank"><?php echo CRMText::_('COBALT_PRINT'); ?></a>
					</li>
					 <li>
	...
	<div class="row-fluid">
		<div class="columncontainer">
			<div class="threecolumn">
				...
				<div class="cobaltRow top">
					...
					<div class="cobaltValue">
						...
						<?php } else {
							echo CRMText::_('COBALT_NO_COMPANY');
						} ?>
					</div>
				</div>
				<div class="cobaltRow">
					...
					<div class="cobaltValue">
		                <div class='dropdown'>
	                        ...
	                        <?php 	$me = array(array('label'=>CRMText::_('COBALT_ME'),'value'=>CobaltHelperUsers::getLoggedInUser()->id));
			...
			<div class="threecolumn">
				...
				<div class="cobaltRow top">
					<div class="cobaltField"><?php echo CRMText::_('COBALT_TITLE'); ?>:</div>
					<div class="cobaltValue">
						<?php $personTitle = $person['position'] != "" && !is_null($person['position']) ? $person['position'] : CRMText::_("COBALT_CLICK_TO_EDIT"); ?>
						<a href="javascript:void(0);" rel="popover" data-title="<?php echo ucwords(CRMText::_('COBALT_UPDATE_FIELD').' '.CRMText::_('COBALT_TITLE')); ?>" data-html='true' data-content='<div class="input-prepend input-append"><form class="inline-form" id="position_form">
				...
				<div class="cobaltRow">
					<div class="cobaltField"><?php echo CRMText::_('COBALT_TYPE'); ?>:</div>
					<div class="cobaltValue">
		                <div class='dropdown'>
	                        <a href='javascript:void(0);' class='dropdown-toggle update-toggle-html' role='button' data-toggle='dropdown' id='person_type_<?php echo $person['id']; ?>_link'>
	                        	<span id="type_<?php echo $person['id']; ?>">
		                        	<?php $person_type = ( array_key_exists('type',$person) && $person['type'] != "" ) ? $person['type'] : CRMText::_('COBALT_NOT_SET'); ?>
			...
			<div class="threecolumn">
				...
				<div class="cobaltRow top">
					<div class="cobaltField"><?php echo CRMText::_('COBALT_STATUS'); ?>:</div>
					<div class="cobaltValue">
	                    <div class='dropdown'>
	                        <a href='javascript:void(0);' class='dropdown-toggle update-toggle-html' role='button' data-toggle='dropdown' id='person_status_<?php echo $person['id']; ?>_link'>
	                        	<span id="status_name_<?php echo $person['id']; ?>">
		                        	<?php 	$statusName = ( $person['status_name'] == '' ) ? CRMText::_('COBALT_NO_STATUS') : $person['status_name'];  ?>
				...
				<div class="cobaltRow">
					<div class="cobaltField"><?php echo CRMText::_('COBALT_SOURCE'); ?>:</div>
					<div class="cobaltValue">
	                     <div class='dropdown'>
	                        <a href='javascript:void(0);' class='dropdown-toggle update-toggle-html' role='button' data-toggle='dropdown' id='person_source_<?php echo $person['id']; ?>_link'>
	                        	<span id="source_name_<?php echo $person['id']; ?>">
		                        	<?php $sourceName = $person['source_id'] > 0 ? $person['source_name'] : CRMText::_('COBALT_CLICK_TO_EDIT'); ?>
		                        	<?php echo $sourceName; ?>
	                        	</span>
	                        </a>
	                        <ul class="dropdown-menu" role="menu">
		...
		<!-- DEALS -->
		<h2><?php echo ucwords(CRMText::_('COBALT_EDIT_DEALS')); ?></h2>
	...
	<div class="span4">
			...
			<div class="widget" id="details">
				...
				<?php if ( array_key_exists('work_address_1',$person) && $person['work_address_1'] != "" ) { ?>
					<address>
						<div class="infoBlock">
							<div class="infoLabel"><?php echo CRMText::_('COBALT_WORK_ADDRESS'); ?></div>
							<div class="infoDetails">
				...
				<?php if ( array_key_exists('home_address_1',$person) && $person['home_address_1'] != "" ) { ?>
					<address>
						<div class="infoBlock">
							<div class="infoLabel"><?php echo CRMText::_('COBALT_HOME_ADDRESS'); ?></div>
							<div class="infoDetails">
						...
						<span class="text-center">
								...
								<div class="inline">
									<a data-html="true" data-content='<div class="input-append"><form id="twitter_form_<?php echo $person['id']; ?>">
										...
										<a href="javascript:void(0);" class="btn" onclick="saveEditableModal(this);" ><?php echo CRMText::_('COBALT_SAVE'); ?></a>
									</form></div>' rel="popover" title="<?php echo CRMText::_('COBALT_UPDATE_FIELD').' '.CRMText::_('COBALT_TWITTER'); ?>" href="javascript:void(0);"><div class="twitter_dark"></div></a>
								</div>
								</span>
								<?php } ?>
								...
								<div class="inline">
									...
									</form></div>' rel="popover" title="<?php echo CRMText::_('COBALT_UPDATE_FIELD').' '.CRMText::_('COBALT_FACEBOOK'); ?>" href="javascript:void(0);"><div class="facebook_dark"></div></a>
								</div>
								</span>
								<?php } ?>
								...
								<div class="inline">
									<a data-html="true" data-content='<div class="input-append"><form id="linkedin_form_<?php echo $person['id']; ?>">
										...
										<a href="javascript:void(0);" class="btn button" onclick="saveEditableModal(this);" ><?php echo CRMText::_('COBALT_SAVE'); ?></a>
									</form></div>' rel="popover" title="<?php echo CRMText::_('COBALT_UPDATE_FIELD').' '.CRMText::_('COBALT_LINKEDIN'); ?>" href="javascript:void(0);"><div class="linkedin_dark"></div></a>
								</div>
								</span>
								<?php } ?>
								...
								<div class="inline">
									<?php if(array_key_exists('aim',$person) && $person['aim'] != "" ){ ?>
										...
										<a href="javascript:void(0);" class="btn button" onclick="saveEditableModal(this);" ><?php echo CRMText::_('COBALT_SAVE'); ?></a>
									</form></div>' rel="popover" title="<?php echo CRMText::_('COBALT_UPDATE_FIELD').' '.CRMText::_('COBALT_AIM'); ?>" href="javascript:void(0);"><div class="aim_light"></div></a>
									<?php } else { ?>
										<a data-html="true" data-content='<div class="input-append"><form id="aim_form_<?php echo $person['id']; ?>">
										<input type="hidden" name="item_id" value="<?php echo $person['id']; ?>" />
										<input type="hidden" name="item_type" value="people" />
										<input type="text" class="inputbox input-small" name="aim" value="<?php if ( array_key_exists('aim',$person) )  echo $person['aim']; ?>" />
										<a href="javascript:void(0);" class="btn button" onclick="saveEditableModal(this);" ><?php echo CRMText::_('COBALT_SAVE'); ?></a>
									</form></div>' rel="popover" title="<?php echo CRMText::_('COBALT_UPDATE_FIELD').' '.CRMText::_('COBALT_AIM'); ?>" href="javascript:void(0);"><div id="aim_button_<?php echo $person['id']; ?>" class="aim_dark"></div></a>
									<?php } ?>
								</div>
								</span>
							</div>
		...
		<?php if ( $this->acymailing ){ ?>
			<div class="widget" id='acymailing'>
				<h3><?php echo ucwords(CRMText::_('COBALT_ACYMAILING_HEADER')); ?></h3>
