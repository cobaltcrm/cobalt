<?php
    ...
    //assign null data
    $person['company_name'] = ( $person['company_name'] == '' ) ? CRMText::_('COBALT_NO_COMPANY') : $person['company_name'];
    $person['status_name'] = ( $person['status_name'] == '' ) ? CRMText::_('COBALT_NO_STATUS') : $person['status_name'];
    $person['source_name'] = ( $person['source_name'] == '' ) ? CRMText::_('COBALT_NO_SOURCE') : $person['source_name'];
    //assign tabs
    ...
    echo "<tr id='list_row_".$person['id']."' class='cobalt_row_".$k."'>";
        ...
        echo "<td class='company' ><a href='".JRoute::_('index.php?view=companies&layout=company&id='.$person['company_id'])."'>".$person['company_name']."</a></td>";
        echo "<td class='owner' >";
        ...
        <td class="notes"><a rel="tooltip" title="<?php echo CRMText::_('COBALT_VIEW_NOTES'); ?>" data-placement="bottom" class="btn" href="javascript:void(0);" onclick="openNoteModal(<?php echo $person['id']; ?>,'people');"><i class="icon-file"></i></a>
        <?php
