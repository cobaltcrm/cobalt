...
<div class="modal hide fade" id="ajax_search_person_dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <input class="inputbox" type="text" name="person_name" placeholder="<?php echo CRMText::_('COBALT_BEGIN_TYPING_TO_SEARCH'); ?>" value="" />
        </div>
         <div class="modal-footer">
            <div class="actions"><input class="btn btn-success" type="button" value="<?php echo CRMText::_('COBALT_SAVE'); ?>" onclick="saveCf('people');closeDialog('person')"/> <?php echo CRMText::_('COBALT_OR'); ?> <a href="javascript:void(0);" onclick="closeDialog('person')"><?php echo CRMText::_('COBALT_CANCEL'); ?></a></div>
        </div>
</div>
