...
<ul class="nav nav-tabs" id="myTab">
	...
	<div class="tab-content">
	  <div class="tab-pane active fade in" id="Task">
	  	<div class="cobaltRow">
			<div class="cobaltField"><?php echo ucwords(CRMText::_('COBALT_EDIT_TASK_NAME')); ?><span class="required">*</span></div>
		...
		<div class="cobaltRow">
			<div class="cobaltField">
				<?php echo CRMText::_('COBALT_CREATED_BY'); ?>
			</div>
		...
		<?php } ?>
		<div class="cobaltRow">
			<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_TASK_TYPE'); ?></div>
			<div class="cobaltValue">
		...
		<div class="cobaltRow">
			<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_TASK_DESCRIPTION'); ?></div>
			<div class="cobaltValue">
	  ...
	  <div class="tab-pane fade" id="Assignment">
	  	<div class="cobaltRow">
			<div class="cobaltField">
				<?php echo CRMText::_('COBALT_ASSOCIATE'); ?>
			</div>
			<div class="cobaltValue">
		        <div id="associate_to_container">
		            ...
		            <?php } else { ?>
		            	<?php if ( $app->input->getVar('association_id') ) { $association_name = $this->association_name;  } else { $association_name = ucwords(CRMText::_('COBALT_COMPANY_DEAL_OR_PERSON'));} ?>
		...
		<div class="cobaltRow">
			<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_TASK_ASSIGN_TO'); ?></div>
			<div class="cobaltValue">
				<select class="inputbox" name="assignee_id">
					<?php 
						$users = array();
						$users[CobaltHelperUsers::getUserId()] = CRMText::_('COBALT_ME');
	                    $users += CobaltHelperDropdown::getUserNames();
	  ...
	  <div class="tab-pane fade" id="Date">
	  	<div class="cobaltRow">
		<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_TASK_DUE_DATE'); ?></div>
		<div class="cobaltValue">
			<div id="due_date_container">
			    <?php if (array_key_exists('due_date',$event) ) { ?>
					<span style="display:none;" class="due_date"><?php echo CRMText::_('COBALT_EDIT_TASK_DUE_DATE_MESSAGE'); ?></span>
				<div id="due_date">
				...
				<?php } else { ?>
				<span class="due_date"><?php echo CRMText::_('COBALT_EDIT_TASK_DUE_DATE_MESSAGE'); ?></span>
	...
	<div class="cobaltRow">
		<div class="cobaltField"><?php echo CRMText::_('COBALT_END_DATE'); ?></div>
		<div class="cobaltValue">
				...
				<span <?php echo $hidden; ?> class="end_date"><?php echo CRMText::_('COBALT_END_DATE_MESSAGE'); ?></span>
    ...
    <div class="cobaltRow">
     	<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_TASK_REPEAT'); ?></div>
        <div class="cobaltValue">
            <select class="inputbox" name="repeats">
                <?php 
                    $repeat_intervals = CobaltHelperEvent::getRepeatIntervals();
    ...
    <div class="cobaltRow">
      ...
      <div class="cobaltField"><?php echo CRMText::_('COBALT_UPDATE_FUTURE_EVENTS'); ?></div>
