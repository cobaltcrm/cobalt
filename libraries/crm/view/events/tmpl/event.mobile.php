...
<?php $event = $this->events; ?>
	...
	<div data-role='header' data-theme='b'>
		...
		<div data-role="collapsible">
			<h3><?php echo CRMText::_('COBALT_DETAILS'); ?></h3>
			...
			<div data-role="fieldcontain">
			 	<fieldset data-role="controlgroup">
					...
					<?php $event_status = $event['completed'] == 1 ? CRMText::_('COBALT_MARK_INCOMPLETE') : CRMText::_('COBALT_MARK_COMPLETE'); ?>
		...
		<?php if($event['deal_name']!="") { ?>
			<div data-role="collapsible">
				<h3><?php echo ucwords(CRMText::_('COBALT_ASSOCIATED_DEALS')); ?></h3>
				<ul data-inset='true' data-role='listview' data-theme="c">				
					<li>
