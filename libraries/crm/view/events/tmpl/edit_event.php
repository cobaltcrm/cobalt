...
<form class="validate" id="edit_event_form">
	...
	<div class="tab-content">
	  <div class="tab-pane active fade in" id="Event">
			<div class="cobaltRow">
				<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_TASK_NAME'); ?><span class="required">*</span></div>
			...
			<div class="cobaltRow">
				<div class="cobaltField">
					<?php echo CRMText::_('COBALT_EDIT_TASK_TYPE'); ?>
				</div>
				<div class="cobaltValue">
	  ...
	  <div class="tab-pane fade" id="Assignment">
	  		<div class="cobaltRow">
				...
				<div class="cobaltValue">
			        <div id="associate_to_container">
                        ...
                        <?php } else { ?>
                        	<?php if ( $app->input->get('association_id') ) { $association_name = $this->association_name;  } else { $association_name = ucwords(CRMText::_('COBALT_COMPANY_DEAL_OR_PERSON'));} ?>
			...
			<div class="cobaltRow">
				<div class="cobaltField">
					<?php echo CRMText::_('COBALT_EDIT_TASK_ASSIGN_TO'); ?>
				</div>
				<div class="cobaltValue">
	  ...
	  <div class="tab-pane fade" id="Date">
	  	<div class="cobaltRow">
			<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_EVENT_START_TIME'); ?><span class="required">*</span></div>
			<div class="cobaltValue">
		...
		<div class="cobaltRow">
			<div class="cobaltField"><?php echo CRMText::_('COBALT_EDIT_EVENT_END_TIME'); ?><span class="required">*</span></div>
			<div class="cobaltValue">
		...
		<div class="cobaltRow">
			<label class="checkbox">
				<input type="checkbox" name="all_day" /><?php echo CRMText::_('COBALT_EDIT_EVENT_ALL_DAY_MESSAGE'); ?>
			</label>
		</div>
		<div class="cobaltRow">
