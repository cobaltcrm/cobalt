...
<tr id='list_row_<?php echo $company['id']; ?>' class='cobalt_row_<?php echo $k; ?>'>
    ...
    <td class="notes" >
        <div class="btn-group">
            <a rel="tooltip" title="<?php echo CRMText::_('COBALT_VIEW_CONTACTS'); ?>" data-placement="bottom" class="btn" href="javascript:void(0);" onclick="showCompanyContactsDialogModal(<?php echo $company['id']; ?>);"><i class="icon-user"></i></a>
            <a rel="tooltip" title="<?php echo CRMText::_('COBALT_VIEW_NOTES'); ?>" data-placement="bottom" class="btn" href="javascript:void(0);" onclick="openNoteModal(<?php echo $company['id']; ?>,'company');"><i class="icon-file"></i></a>
        </div>
    </td>
</tr>