...
<script type="text/javascript">
    ...
    <div data-remote="index.php?view=companies&layout=edit&format=raw&tmpl=component" class="modal hide fade" id="companyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-header">
            ...
            <h3 id="myModalLabel"><?php echo ucwords(CRMText::_('COBALT_ADD_COMPANY')); ?></h3>
        </div>
...
<div class="page-header">
    <div class="btn-group pull-right">
        <a rel="tooltip" title="<?php echo CRMText::_('COBALT_ADD_COMPANY'); ?>" data-placement="bottom" class="btn btn-success" role="button" href="#companyModal" data-toggle="modal"><i class="icon-plus icon-white"></i></a>
        <a rel="tooltip" title="<?php echo CRMText::_('COBALT_IMPORT_COMPANIES'); ?>" data-placement="bottom"  class="btn" href="<?php echo JRoute::_('index.php?view=import&import_type=companies'); ?>"><i class="icon-circle-arrow-up"></i></a>
        <?php if ( CobaltHelperUsers::canExport() ){ ?>    
            <a rel="tooltip" title="<?php echo CRMText::_('COBALT_EXPORT_COMPANIES'); ?>" data-placement="bottom" class="btn"href="javascript:void(0)" onclick="exportCsv()"><i class="icon-share"></i></a>
        <?php } ?>  
    </div>

    <h1><?php echo ucwords(CRMText::_('COBALT_COMPANIES')); ?></h1>
</div>
<ul class="inline-list">
    ...
    <li>
        ...
        <input class="inputbox filter_input" name="company_name" type="text" placeholder="<?php echo CRMText::_('COBALT_ANYTHING'); ?>" value="<?php echo $this->company_filter; ?>">
    </li>
    <li>
...
<small>
    <span id="companies_matched"></span> <?php echo CRMText::_('COBALT_COMPANIES_MATCHED'); ?> <?php echo CRMText::_('COBALT_THERE_ARE'); ?> <?php echo $this->company_count; ?> <?php echo CRMText::_('COBALT_COMPANIES_IN_ACCOUNT'); ?>
</small>
<?php echo CobaltHelperTemplate::getListEditActions(); ?>
<form method="post" id="list_form" action="<?php echo JRoute::_('index.php?view=companies'); ?>" >
