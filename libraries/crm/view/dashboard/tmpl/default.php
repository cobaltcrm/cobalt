                ...
                <div class="dash_float" id="deals_container">   
                    ...
                    <div id="deals">
                        <table class="table table-striped table-hover table-bordered" id="deal_list">
                            <tr>
                                <th><?php echo CRMText::_('COBALT_DEAL_NAME'); ?></th>
                                <th><?php echo CRMText::_('COBALT_DEAL_STATUS'); ?></th>
                                <th class="right"><?php echo CRMText::_('COBALT_DEAL_AMOUNT'); ?></th>
                            </tr>
                            <?php
            ...
            <li class="widget">
                <div class="dash_float" id="sales_container">
                    <div class="dash_float_header">
                        ...
                        <h3><?php echo CRMText::_('COBALT_SALES_HEADER'); ?></h3>
                    </div>
            ...
            <li class='widget'>
                <div class="dash_float" id="inbox_container">
                    <div class="dash_float_header">
                        ...
                        <h3><?php echo CRMText::_('COBALT_INBOX_HEADER'); ?></h3>
                    </div>
                    <div id="inbox">
                        <table class="table table-striped table-hover table-bordered" id="mail_table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo CRMText::_('COBALT_FROM'); ?></th>
                                    <th><?php echo CRMText::_('COBALT_TO'); ?></th>
                                    <th><?php echo CRMText::_("COBALT_RECEIVED"); ?></th>
                                    <th></th>
                                </tr>
                            </thead>
                ...
                <div class="dash_float" id="latest_container">
                    ...
                    <div id="latest">
                        <table class="table table-striped table-hover table-bordered" id="latest_activity">
                            <thead>
                                <tr>
                                    <th><?php echo CRMText::_('COBALT_ITEM'); ?></th>
                                    <th><?php echo CRMText::_('COBALT_ACTION'); ?></th>
                                    <th><?php echo CRMText::_('COBALT_BY'); ?></th>
                                    <th><?php echo CRMText::_('COBALT_OCCURRED'); ?></th>
                                </tr>
                            </thead>
