...
<table width="600" cellpadding="0" cellspacing="10" border="0" align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
	<tr>
      ...
      <p><strong><?php echo CRMText::_('COBALT_MORNING_COFFEE_REPORT_TITLE') ?> <?php echo $this->user->first_name.' '.$this->user->last_name; ?><br><?php echo CRMText::_('COBALT_SUMMARY_FOR'); ?> <?php echo CobaltHelperDate::formatDate(date('Y-m-d')); ?></strong> <br>
        <a href="<?php echo JURI::base().'/index.php?option=com_user&view=login'; ?>" style="color:#999999;"><?php echo CRMText::_('COBALT_LOGIN'); ?></a>      </p>
		</td>
	</tr>
	<tr>
		<td colspan="2">
			<table width="100%" border="0" cellpadding="5" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
				<tr>
					<td style="font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;" colspan="2"><?php echo ucwords(CRMText::_('COBALT_SALES_PIPELINE')); ?></td>
				</tr>
				<tr>
					<td style="color: #039718; font-weight: bold; font-size: 14px;"><?php echo ucwords(CRMText::_('COBALT_ACTIVE_DEALS')); ?></td>
	...
	<tr>
		<td valign="top" width="50%">
			<table width="100%" border="0" cellpadding="5" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
				<tr>
					<td style="font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;" colspan="2"><?php echo ucwords(CRMText::_('COBALT_DEALS')); ?></td>
				</tr>
				<?php
				$n = count($this->stages); 
		...
		<td valign="top" width="50%">
			<table width="100%" border="0" cellpadding="5" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
				<tr>
					<td style="font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;" colspan="2"><?php echo ucwords(CRMText::_('COBALT_LEADS')); ?></td>
				</tr>
				<tr>
					<td style="color: #039718;"><?php echo ucwords(CRMText::_('COBALT_CONVERTED_TO_CONTACTS')); ?></td>
         			<td align="right" style="color: #039718;"><?php echo $this->numConvertedLeads; ?></td>
				</tr>
				<tr>
					<td style="color:#CB6A13;"><?php echo ucwords(CRMText::_('COBALT_NEW')); ?></td>
	...
	<tr>
		<td valign="top" width="50%">
			<table width="100%" border="0" cellpadding="5" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:11px;">
				<tr>
		        	<td style="font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;" colspan="2"><?php echo CRMText::_('COBALT_NOTES_WRITTEN'); ?></td>
		        </tr>
		        <?php 
		        $c = count($this->notes);
		        $totalNotes = 0;
		        ...
		        <?php } } ?>
				<tr>
					<td><?php echo CRMText::_('COBALT_TOTAL'); ?></td>
		...
		<td valign="top" width="50%">
			<table border='0' cellpadding='5' cellspacing='0' style='font-family:Arial, Helvetica, sans-serif; font-size:11px;' width='100%'>
				<tr>
					<td colspan='2' style='font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;'><?php echo ucwords(CRMText::_('COBALT_TODOS_COMPLETED')); ?></td>
				</tr>
				<?php 
				$c = count($this->todos);
				...
				<?php } } ?>
				<tr>
					<td><?php echo ucwords(CRMText::_('COBALT_TOTAL_NEW')); ?></td>
					<td align='right'><?php echo $totalNewTodos; ?></td>
				</tr>
				<tr>
					<td><?php echo ucwords(CRMText::_('COBALT_TOTAL_COMPLETED')); ?></td>
	...
	<?php /**
	<tr>
		<td style="font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;" colspan="2"><?php echo CRMText::_('COBALT_DEAL_ACTIVITY'); ?></td>
	</tr>
	<tr>
		<td>
			<table border='0' cellpadding='5' cellspacing='0' style='font-family:Arial, Helvetica, sans-serif; font-size:11px;' width='100%'>
			...
			?>
				<tr>
			  		...
			  		<td><?php echo CRMText::_('COBALT_ACTIVITY_UPDATED',$da->field,$da->old_value,$da->new_value); ?></td>
				</tr>
			<?php } ?>
			</table>
		</td>
	...
	<tr>
		<td style="font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;" colspan="2"><?php echo CRMText::_('COBALT_LEADS_ACTIVITY'); ?></td>
	</tr>
	<tr>
		<td>
			<table border='0' cellpadding='5' cellspacing='0' style='font-family:Arial, Helvetica, sans-serif; font-size:11px;' width='100%'>
			...
			?>
				<tr>
			  		...
			  		<td><?php echo CRMText::_('COBALT_ACTIVITY_UPDATED',$la->field,$la->old_value,$la->new_value); ?></td>
				</tr>
			<?php } ?>
			</table>
		</td>
	...
	<tr>
		<td style="font-size:14px; font-weight: bold; border-bottom: 1px solid #cccccc; color: #1E759E;" colspan="2"><?php echo CRMText::_('COBALT_CONTACTS_ACTIVITY'); ?></td>
	</tr> 
	<tr>
		<td>
			<table border='0' cellpadding='5' cellspacing='0' style='font-family:Arial, Helvetica, sans-serif; font-size:11px;' width='100%'>
			...
			?>
				<tr>
			  		...
			  		<td><?php echo CRMText::_('COBALT_ACTIVITY_UPDATED',$ca->field,$ca->old_value,$ca->new_value); ?></td>
				</tr>
			<?php } ?>
			</table>
		</td>
