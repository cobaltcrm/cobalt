  ...
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#personal">
        <?php echo CRMText::_('COBALT_EDIT_PERSONAL_INFO'); ?>
      </a>
    </div>
    <div id="personal" class="accordion-body collapse">
      <div class="accordion-inner">
        <form>
            <fieldset>
                <ul class="unstyled">
                    <li><label><?php echo CRMText::_('COBALT_PERSON_FIRST'); ?></label><input class="inputbox" type="text" name="first_name" value="<?php echo $this->user->first_name; ?>"></li>
                    <li><label><?php echo CRMText::_('COBALT_PERSON_LAST'); ?></label><input class="inputbox" type="text" name="last_name" value="<?php echo $this->user->last_name; ?>"></li>
                </ul>
            </fieldset>
        </form>
        <input type="button" value="<?php echo CRMText::_('COBALT_SAVE'); ?>" class="btn btn-success button save" > - <input type="button" value="<?php echo CRMText::_('COBALT_CANCEL'); ?>" class="button btn cancel">
  ...
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#date">
        <?php echo CRMText::_('COBALT_DATE_TIME_SETTINGS'); ?>
      </a>
    </div>
    <div id="date" class="accordion-body collapse">
      <div class="accordion-inner">
            ...
            <input type="button" value="<?php echo CRMText::_('COBALT_SAVE'); ?>" class="btn btn-success button save" > - <input type="button" value="<?php echo CRMText::_('COBALT_CANCEL'); ?>" class="btn button cancel">
      </div>
    </div>
  </div>
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#email1">
        <?php echo CRMText::_('COBALT_USER_INBOX_MULTIPLE_EMAILS'); ?>
      </a>
    </div>
      ...
      <div class="accordion-inner">
            <form>
                <fieldset>
                    ...
                    <a class="add_email_link" onclick="addEmailBox();"><?php echo CRMText::_('COBALT_ADD_ANOTHER_EMAIL'); ?></a>
                </fieldset>
            </form>
            <input type="button" value="<?php echo CRMText::_('COBALT_SAVE'); ?>" class="btn btn-success button save" > - <input type="button" value="<?php echo CRMText::_('COBALT_CANCEL'); ?>" class="btn button cancel">
      </div>
  ...
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#email2">
        <?php echo CRMText::_('COBALT_EMAIL_PREF_REMINDERS'); ?>
      </a>
    </div>
    <div id="email2" class="accordion-body collapse">
      <div class="accordion-inner">
                ...
                <fieldset>
                    <ul class="unstyled" >
                        ...
                        <li>
                            ...
                            <span class="faux_input"><b><?php echo CRMText::_('COBALT_DAILY_AGENDA'); ?></b></span>
                            <span class="faux_input_details"><?php echo CRMText::_('COBALT_DAILY_AGENDA_DESC'); ?></span>
                        </li>
                         **/ ?>
                        <li>
                            <label class="small"><input type="checkbox" name="morning_coffee" <?php if ( $this->user->morning_coffee ) echo 'checked'; ?>></label>
                            <span class="faux_input"><b><?php echo CRMText::_('COBALT_MORNING_COFFEE'); ?></b></span>
                        ...
                        <li>
                            ...
                            <span class="faux_input_details"><?php echo CRMText::_('COBALT_TEAM_USE_REPORT_DESC'); ?></span>
                        </li>
                        <?php } ?>
                        <li>
                            ...
                            <span class="faux_input"><b><?php echo CRMText::_('COBALT_TEAM_USE_REPORT'); ?></b></span>
                            <span class="faux_input_details"><?php echo CRMText::_('COBALT_PERSONAL_USE_REPORT_DESC'); ?></span>
                        </li>
            ...
            <input type="button" value="<?php echo CRMText::_('COBALT_SAVE'); ?>" class="button btn btn-success save" > - <input type="button" value="<?php echo CRMText::_('COBALT_CANCEL'); ?>" class="btn button cancel">
      </div>
    </div>
  </div>
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#home">
        <?php echo CRMText::_('COBALT_SET_HOME_CHART'); ?>
      </a>
    </div>
    <div id="home" class="accordion-body collapse">
      <div class="accordion-inner">
            <form>
                <fieldset>
                    <ul class="unstyled">
                        <li><?php echo CRMText::_('COBALT_SET_HOME_CHART_DESC'); ?></li>
                        <li>
                            <label>
  ...
  <div class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#commission">
        <?php echo CRMText::_('COBALT_SET_COMMISSION_RATE'); ?>
      </a>
    </div>
    <div id="commission" class="accordion-body collapse">
      <div class="accordion-inner">
            <form>
                <fieldset>
                    <ul class="unstyled" >
                        <li><?php echo CRMText::_('COBALT_SET_COMMISSION_RATE_DESC'); ?></li>
                        <li>
                            <label>
                                <?php echo CRMText::_('COBALT_COMMISSION_RATE'); ?>
                            </label>
