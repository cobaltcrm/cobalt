...
<form id="deal_form" method="post" name="new_deal" action="<?php echo JRoute::_('index.php?controller=save&model=deal&return=deals'); ?>" target="hidden" onsubmit="save()">
    <div id="editForm">
        ...
        <div class="cobaltRow">
            <div class="cobaltField"><?php echo CRMText::_('COBALT_DEAL_SUMMARY'); ?></div>
        ...
        <div class="cobaltRow">
            <div class="cobaltField"><?php echo CRMText::_('COBALT_DEAL_COMPANY'); ?></div>
            ...
            <?php } ?>
            <div class="cobaltRow">
                <div class="cobaltField"><?php echo CRMText::_('COBALT_DEAL_AMOUNT'); ?></div>
                <div class="cobaltValue"><input class="inputbox" type="text" name="amount" value="<?php if(count($deal)>0) echo $deal['amount']; ?>" /></div>
            </div>
            <div class="cobaltRow">
                <div class="cobaltField"><?php echo CRMText::_('COBALT_DEAL_STAGE'); ?></div>
                <div class="cobaltValue">
                    <?php echo CobaltHelperDropdown::generateDropdown('stage',$deal['stage_id']); ?>
                </div>
            </div>
            <div class="cobaltRow">
                <div class="cobaltField"><?php echo CRMText::_('COBALT_DEAL_SOURCE'); ?></div>
                <div class="cobaltValue">
                    <?php echo CobaltHelperDropdown::generateDropdown('source',$deal['source_id']); ?>
                </div>
            </div>
            <div class="cobaltRow">
                <div class="cobaltField"><?php echo CRMText::_('COBALT_DEAL_PROBABILITY'); ?></div>
                <div class="cobaltValue">
            ...
            <div class="cobaltRow">
                <div class="cobaltField"><?php echo CRMText::_('COBALT_DEAL_STATUS'); ?></div>
                <div class="cobaltValue">
                    <?php echo CobaltHelperDropdown::generateDropdown('deal_status',$deal['status_id']); ?>
                </div>
            </div>
            <div class="cobaltRow">
            ...
            ?>
            <span class="actions"><input class="button" type="submit" value="<?php echo CRMText::_('COBALT_SAVE_BUTTON'); ?>"> <a href="javascript:void(0);" onclick="window.history.back()"><?php echo CRMText::_('COBALT_CANCEL_BUTTON'); ?></a></span>
    <?php
