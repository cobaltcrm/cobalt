...
<div class="page-header">
    ...
    <div data-remote="index.php?view=deals&layout=edit&format=raw&tmpl=component" class="modal hide fade" id="dealModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-header">
            ...
            <h3 id="myModalLabel"><?php echo ucwords(CRMText::_('COBALT_ADD_DEAL')); ?></h3>
        </div>
    ...
    <div class="pull-right btn-group">
        <a rel="tooltip" title="<?php echo CRMText::_('COBALT_ADD_DEALS'); ?>" data-placement="bottom" class="btn btn-success" role="button" href="#dealModal" data-toggle="modal"><i class="icon-plus icon-white"></i></a>
        <a rel="tooltip" title="<?php echo CRMText::_('COBALT_IMPORT_DEALS'); ?>" data-placement="bottom"  class="btn" href="<?php echo JRoute::_('index.php?view=import&import_type=deals'); ?>"><i class="icon-circle-arrow-up"></i></a>
        <?php if ( CobaltHelperUsers::canExport() ) { ?>
            <a rel="tooltip" title="<?php echo CRMText::_('COBALT_EXPORT_DEALS'); ?>" data-placement="bottom" class="btn"href="javascript:void(0)" onclick="exportCsv()"><i class="icon-share"></i></a>
        <?php } ?>
    </div>
    ...
    <ul class="inline-list">
        ...
        <li><span><?php echo CRMText::_('COBALT_FOR'); ?></span></li>
        <li class='dropdown'>
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="deal_user_link">
                <li><a class="filter_user_<?php echo $this->user_id ?>" onclick="dealUser(<?php echo $this->user_id ?>,0)"><?php echo CRMText::_('COBALT_ME'); ?></a></li>
                <?php  if ($this->member_role != 'basic') { ?>
                     <li><a href="javascript:void(0);" class="filter_user_all" onclick="dealUser('all',0)"><?php echo CRMText::_('COBALT_ALL_USERS'); ?></a></li>
                <?php } ?>
                <?php
                   if ($this->member_role == 'exec') {
                        if ( count($this->teams) > 0 ) {
                            foreach ($this->teams as $team) { ?>
                                 <li><a href='javascript:void(0);' class='filter_team_<?php echo $team['team_id']; ?>' onclick='dealUser(0,"<?php echo $team['team_id']; ?>")'><?php echo $team['team_name'].CRMText::_('COBALT_TEAM_APPEND'); ?></a></li>
                             <?php }
                        }
                    }
        ...
        <li><span><?php echo CRMText::_('COBALT_IN'); ?></span></li>
        <li class="dropdown">
        ...
        <li><span><?php echo CRMText::_('COBALT_CLOSING'); ?></span></li>
        <li class="dropdown">
        ...
        <li>
            <?php echo CRMText::_('COBALT_NAMED'); ?>
            <input name="deal_name" type="text" placeholder="<?php echo CRMText::_('COBALT_ANYTHING'); ?>" value="<?php echo $this->deal_filter; ?>">
        </li>
        <li>
    ...
    <small>
        <span id="deals_matched"></span> <?php echo CRMText::_('COBALT_DEALS_MATCHED'); ?> <?php echo CRMText::_("COBALT_THERE_ARE"); ?> <?php echo $this->totalDeals; ?> <?php echo CRMText::_("COBALT_DEALS_IN_ACCOUNT"); ?>
    </small>
<?php echo CobaltHelperTemplate::getListEditActions(); ?>
<form method="post" id="list_form" action="<?php echo JRoute::_('index.php?view=deals'); ?>">
