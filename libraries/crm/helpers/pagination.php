...
class CobaltPagination extends JPagination
{
	...
	/**
	 * @var    String  Link used for request variables.
	 */
	public $link = null;

	/**
	 * @var    String  Base used for request variables.
	 */
	public $base = null;
	 ...
	 * @since   11.1
	 */
	public function __construct($total, $limitstart, $limit, $prefix = '', $link = null)
	{
	...
	public function getResultsCounter()
	{
		...
		{
			$html .= "\n" . CRMText::_('JLIB_HTML_NO_RECORDS_FOUND');
		}
	...
	public function getLimitBox()
	{
		...
		$limits[] = JHtml::_('select.option', '50', CRMText::_('J50'));
		$limits[] = JHtml::_('select.option', '100', CRMText::_('J100'));
		$limits[] = JHtml::_('select.option', '0', CRMText::_('JALL'));
		...
		$html = JHtml::_(
				...
				$limits,
				$this->prefix . 'limit',
				'class="input-mini" size="1" onchange="this.form.submit()"',
				'value',
				'text',
				$selected
			);
	...
	protected function _list_footer($list)
	{
		...
		$html .= "\n<div class=\"limit pull-right\">" . CRMText::_('JGLOBAL_DISPLAY_NUM') . $list['limitfield'] . "</div>";
		$html .= $list['pageslinks'];
		$html .= "\n<div class=\"counter pull-left\">" . $list['pagescounter'] . "</div>";
	...
	protected function _buildDataObject()
	{
		...
		$data->all = new CobaltPaginationObject(CRMText::_('JLIB_HTML_VIEW_ALL'), $this->prefix, $this->base, $this->link);
		if (!$this->_viewall)
		{
			$data->all->base = '0';
		...
		$data->start = new CobaltPaginationObject(CRMText::_('JLIB_HTML_START'), $this->prefix, $this->base, $this->link);
		$data->previous = new CobaltPaginationObject(CRMText::_('JPREV'), $this->prefix, $this->base, $this->link);
		...
		$data->next = new CobaltPaginationObject(CRMText::_('JNEXT'), $this->prefix, $this->base, $this->link);
		$data->end = new CobaltPaginationObject(CRMText::_('JLIB_HTML_END'), $this->prefix, $this->base, $this->link);
