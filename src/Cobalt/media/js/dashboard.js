...
jQuery(document).ready(function(){
	...
	if  ( typeof graphData !== 'undefined' && graphData != null ){
		...
		//show initial pie graph
		showChart(charts[0]);
		currentChart = 0;
		
		//loop through charts
		jQuery("#chart_select_next").bind('click',function(){
			chartLoop('next');
		});
		jQuery("#chart_select_prev").bind('click',function(){
			chartLoop('prev');
		});
		...
		switch ( type ) {
			...
			case "dealStagePie" :
				chart = new Highcharts.Chart({
			         chart: {
									renderTo: 'sales_graphs',
									plotBackgroundColor: null,
									plotBorderWidth: null,
									plotShadow: true
								},
								title: {
									text: Joomla.JText._('COBALT_DEALS_BY_STAGE')
								},
								tooltip: {
									formatter: function() {
				      ...
				      series: [{
				      	type: 'pie',
									name: Joomla.JText._('COBALT_DEALS_BY_STAGE'),
			...
			case 'dealStatusPie' :
				chart = new Highcharts.Chart({
			         chart: {
								...
								title: {
									text: Joomla.JText._('COBALT_DEALS_BY_STATUS')
								},
								tooltip: {
									formatter: function() {
										return '<b>'+ this.point.name +'</b>: '+ this.percentage.toFixed(2) +' %';
				      ...
				      series: [{
				      	type: 'pie',
									name: Joomla.JText._('COBALT_DEALS_BY_STATUS'),
			...
			case 'leadRevenue' :
				chart = new Highcharts.Chart({
			         chart: {
								...
								title: {
									text: Joomla.JText._('COBALT_REVENUE_FROM_LEAD_SOURCES')
								},
								tooltip: {
									formatter: function() {
										return '<b>'+ this.point.name +'</b>: '+'$'+this.point.data;
									}
								},
								plotOptions: {
									pie: {
				      ...
				      series: [{
				      	type: 'pie',
									name: Joomla.JText._('COBALT_REVENUE_FROM_LEAD_SOURCES'),
			...
			chart = new Highcharts.Chart({
								...
								title: {
									text: Joomla.JText._('COBALT_YEARLY_COMMISSIONS')
								},
								xAxis: {
								...
								plotOptions: {
							        ...
							        series: [{
							        	name: Joomla.JText._('COBALT_YEARLY_COMMISSIONS'),
			...
			chart = new Highcharts.Chart({
								...
								title: {
									text: Joomla.JText._('COBALT_MONTHLY_COMMISSIONS')
								},
								xAxis: {
								...
								plotOptions: {
							        ...
							        series: [{
							        	name:Joomla.JText._('COBALT_MONTHLY_COMMISSIONS'),
			...
			case 'yearlyRevenue' :
			 chart = new Highcharts.Chart({
								...
								title: {
									text: Joomla.JText._('COBALT_YEARLY_REVENUE')
								},
								xAxis: {
									categories:graphData.months
								},
								...
								plotOptions: {
							        ...
							        series: [{
							        	name: Joomla.JText._('COBALT_YEARLY_REVENUE'),
			...
			chart = new Highcharts.Chart({
								...
								title: {
									text: Joomla.JText._('COBALT_MONTHLY_REVENUE')
								},
								xAxis: {
									categories:graphData.weeks
								},
								...
								plotOptions: {
							        ...
							        series: [{
							        	name: Joomla.JText._('COBALT_MONTHLY_REVENUE'),
