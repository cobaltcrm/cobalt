...
var defaults = {
	...
	isRTL: false,
	firstDay: 0,
	monthNames: [Joomla.JText._('COBALT_JANUARY'),
				Joomla.JText._('COBALT_FEBRUARY'),
				Joomla.JText._('COBALT_MARCH'),
				Joomla.JText._('COBALT_APRIL'),
				Joomla.JText._('COBALT_MAY'),
				Joomla.JText._('COBALT_JUNE'),
				Joomla.JText._('COBALT_JULY'),
				Joomla.JText._('COBALT_AUGUST'),
				Joomla.JText._('COBALT_SEPTEMBER'),
				Joomla.JText._('COBALT_OCTOBER'),
				Joomla.JText._('COBALT_NOVEMBER'),
				Joomla.JText._('COBALT_DECEMBER')
				],
	monthNamesShort: [Joomla.JText._('COBALT_JAN'),
					Joomla.JText._('COBALT_FEB'),
					Joomla.JText._('COBALT_MAR'),
					Joomla.JText._('COBALT_APR'),
					Joomla.JText._('COBALT_MAY'),
					Joomla.JText._('COBALT_JUN'),
					Joomla.JText._('COBALT_JUL'),
					Joomla.JText._('COBALT_AUG'),
					Joomla.JText._('COBALT_SEP'),
					Joomla.JText._('COBALT_OCT'),
					Joomla.JText._('COBALT_NOV'),
					Joomla.JText._('COBALT_DEC')
					],
	dayNames: [Joomla.JText._('COBALT_SUNDAY'),
				Joomla.JText._('COBALT_MONDAY'),
				Joomla.JText._('COBALT_TUESDAY'),
				Joomla.JText._('COBALT_WEDNESDAY'),
				Joomla.JText._('COBALT_THURSDAY'),
				Joomla.JText._('COBALT_FRIDAY'),
				Joomla.JText._('COBALT_SATURDAY')
				],
	dayNamesShort: [Joomla.JText._('COBALT_SUN'),
					Joomla.JText._('COBALT_MON'),
					Joomla.JText._('COBALT_TUE'),
					Joomla.JText._('COBALT_WED'),
					Joomla.JText._('COBALT_THU'),
					Joomla.JText._('COBALT_FRI'),
					Joomla.JText._('COBALT_SAT')
					],
	buttonText: {
		prev: '&nbsp;&#9668;&nbsp;',
		next: '&nbsp;&#9658;&nbsp;',
		prevYear: '&nbsp;&lt;&lt;&nbsp;',
		nextYear: '&nbsp;&gt;&gt;&nbsp;',
		today: Joomla.JText._('COBALT_TODAY'),
		month: Joomla.JText._('COBALT_MONTH'),
		week: Joomla.JText._('COBALT_WEEK'),
		day: Joomla.JText._('COBALT_DAY')
	},
		...
		if (!ignoreWindowResize) {
			if (currentView.start) { // view has already been rendered
				...
				setTimeout(function() { // add a delay
					if (id == resizeUID && !ignoreWindowResize && elementVisible()) {
				...
				jQuery.each(this.split(','), function(j, buttonName) {
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							var button = jQuery(
								"<span class='btn btn-mini fc-button fc-button-" + buttonName + " " + tm + "-state-default'>" +
