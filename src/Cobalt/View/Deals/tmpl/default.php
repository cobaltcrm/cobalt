...
<div class="page-header">
    ...
    <div class="col-xs-5 col-sm-6 col-md-5 va-m"><h3><?php echo ucwords(TextHelper::_('COBALT_DEALS_HEADER')); ?></h3></div>
    ...
    <div class="page-list">
        <div class="table-responsive">
            <form method="post" id="list_form" action="<?php echo RouteHelper::_('index.php?view=deals'); ?>">
                <table class="table table-hover table-striped table-bordered data-table" id="deals">
