            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <ul class="nav nav-tabs" id="myTab">
                        <li class="active"><a data-toggle="tab" href="#import_begin"><?php echo TextHelper::_('COBALT_IMPORT_BEGIN'); ?></a></li>
                        <li><a data-toggle="tab" href="#import_review"><?php echo TextHelper::_('COBALT_IMPORT_REVIEW'); ?></a></li>
                        <li><a data-toggle="tab" href="#import_sample_tab"><?php echo TextHelper::_('COBALT_IMPORT_SAMPLE_DATA'); ?></a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="import_begin">
                            <div class="step">
                                <div class="title">
                                    <h3><?php echo TextHelper::_('COBALT_STEP_ONE'); ?></h3>
                                </div>
                                <div class="text">
                                    <ul>
                                        <li><?php echo TextHelper::_('COBALT_EXPORT_YOUR_FILE_INSTRUCTIONS'); ?></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="step">
                                <div class="title">
                                    <h3><?php echo TextHelper::_('COBALT_STEP_TWO'); ?></h3>
                                </div>
                                <div class="text">
                                    <ul>
                                        <li><?php echo TextHelper::_('COBALT_ENSURE_YOUR_FILE_IS_FORMATTED'); ?></li>
                                        <li><?php echo TextHelper::_('COBALT_ENSURE_YOUR_FILE_IS_FORMATTED_INSTRUCTIONS'); ?></li>
                                        <li>
                                            <form class="inline-form" method="post">
                                                <input class="btn" onclick="downloadImportTemplate(this)" type="button" value="<?php echo TextHelper::_('COBALT_DOWNLOAD_COMPANIES_TEMPLATE'); ?>" />
                                                <input type="hidden" name="template_type" value="companies" />
                                            </form>
                                        </li>
                                        <li>
                                            <form class="inline-form" method="post">
                                                <input class="btn" onclick="downloadImportTemplate(this)" type="button" value="<?php echo TextHelper::_('COBALT_DOWNLOAD_DEALS_TEMPLATE'); ?>" />
                                                <input type="hidden" name="template_type" value="deals" />
                                            </form>
                                        </li>
                                        <li>
                                            <form class="inline-form" method="post">
                                                <input class="btn" onclick="downloadImportTemplate(this)" type="button" value="<?php echo TextHelper::_('COBALT_DOWNLOAD_PEOPLE_TEMPLATE'); ?>" />
                            ...
                            <div class="step">
                                <div class="title">
                                    <h3><?php echo TextHelper::_('COBALT_STEP_THREE'); ?></h3>
                                </div>
                                <div class="text">
                                    <ul>
                                        <li><?php echo TextHelper::_('COBALT_UPLOAD_YOUR_FILE'); ?></li>
                                        <li><?php echo TextHelper::_('COBALT_SELECT_YOUR_CSV'); ?>
                                            <form id="import_form" action="index.php?view=import" method="post" enctype="multipart/form-data">
                                                <div class="input_upload_button" >
                                                    <label><?php echo TextHelper::_('COBALT_TYPE'); ?></label>
                                                    <?php echo DropdownHelper::showImportTypes(); ?>
                                                    <input type="hidden" name="type" value="people" />
                                                    <label><?php echo TextHelper::_('COBALT_FILE'); ?></label>
                                                    <input class="input-file" type="file" name="document" />
                                                    <label></label>
                                                    <input class="btn btn-primary" type="submit" value="<?php echo TextHelper::_('COBALT_IMPORT_DATA'); ?>" />
                                                </div>
                                            </form>
                                        </li>
                                    </ul>
                         ...
                         <div class="tab-pane" id="import_review" >
                             <div id="import_review_container">
                                ...
                                <?php } else { ?>
                                    <p><div class="alert alert-error"><?php echo TextHelper::_('COBALT_REVIEW_IMPORT_MESSAGE_ERROR'); ?></div></p>
                                <?php } ?>
                                <?php if ( isset($this->import_data) && count($this->import_data) > 1 ) { ?>
                                    <div id="import_seek">
                                        <span>
                                            ...
                                            <a href="javascript:void(0)" onclick="seekImport(-1);"><?php echo TextHelper::_('COBALT_PREVIOUS'); ?></a> -
                                ...
                                <form action="<?php echo RouteHelper::_('index.php?task=import'); ?>" method="post">
                                        ...
                                        <div class="import_buttons">
                                            <input class="btn btn-primary" type="submit" value="<?php echo TextHelper::_('COBALT_IMPORT'); ?>" /><a class="btn" onclick="window.location.href='index.php?view=import'"><?php echo TextHelper::_('COBALT_CANCEL'); ?></a>
                                        </div>
                                        <?php } ?>
                                        </div>
                                ...
                                <?php } else { ?>
                                    <p>
                                        <div class="alert alert-warning"><strong><?php echo TextHelper::_('COBALT_NO_DATA_IMPORTED'); ?></strong></div>
                                    </p>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="tab-pane" id="import_sample_tab">
                            <div class="sample_text">
                                <h3><?php echo TextHelper::_('COBALT_INSTALL_SAMPLE_DATA_TITLE'); ?></h3>
                                <p><div class="alert alert-info"><?php echo TextHelper::_('COBALT_INSTALL_SAMPLE_DATA_DESC'); ?></div></p>
                                <form action="<?php echo RouteHelper::_('index.php?view=import'); ?>" method="post" name="adminForm" id="adminForm" class="inline-form"  >
                                    <input type="submit" value="<?php echo TextHelper::_('COBALT_INSTALL_SAMPLE_BUTTON'); ?>" class="btn btn-primary" />
