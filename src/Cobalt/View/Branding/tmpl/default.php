                    ...
                    <form enctype="multipart/form-data" action="index.php?view=branding" method="post" name="adminForm" id="adminForm">
                        <fieldset class="adminform">
                            ...
                            <table cellspacing="0" cellpadding="0" class="table table-striped table-hover">
                                <thead>
                                    <th><?php echo JText::_("COBALT_ADMIN_GENERIC_HEADER"); ?></th>
                                    <th><?php echo JText::_("COBALT_ADMIN_GENERIC_HEADER"); ?></th>
                                    <th><?php echo JText::_("COBALT_ADMIN_GENERIC_HEADER"); ?></th>
                                    <th><?php echo JText::_("COBALT_ADMIN_GENERIC_HEADER"); ?></th>
                                </thead>
                                <tbody>
                                        <tr class='cobalt_row_0'>
                                            <td><a href="javascript:void(0);"><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></a></td>
                                            <td><a href="javascript:void(0);"><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></a></td>
                                            <td><a href="javascript:void(0);"><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></a></td>
                                            <td><a href="javascript:void(0);"><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></a></td>
                                        </tr>
                                        <tr class='cobalt_row_1'>
                                            <td><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></td>
                                            <td><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></td>
                                            <td><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></td>
                                            <td><?php echo JText::_("COBALT_ADMIN_GENERIC_TEXT"); ?></td>
                                        </tr>
                        ...
                        <fieldset class="adminform">
                            <legend><h3><?php echo JText::_("COBALT_ADMIN_UPLOAD_LOGO"); ?></h3></legend>
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                  ...
                                  <div>
                                    <span class="btn btn-file btn-primary"><span class="fileupload-new"><?php echo JText::_('COBALT_SELECT_IMAGE'); ?></span><span class="fileupload-exists"><?php echo JText::_('COBALT_CHANGE'); ?></span><input id="site-logo" name="site_logo" type="file" /></span>
                                    <a href="#" class="btn fileupload-exists" data-dismiss="fileupload"><?php echo JText::_('COBALT_REMOVE'); ?></a>
                                  </div>
                                </div>
                        </fieldset>
                        <fieldset class="adminform">
                        ...
                        <fieldset id="customization_area" class="adminform">
                            <legend><h3><?php echo JText::_("COBALT_ADMIN_THEME_CUSTOMIZATION"); ?></h3></legend>
