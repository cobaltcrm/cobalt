    ...
    foreach ($custom as $field => $value) {
        if ($value['type'] != 'forecast') {
            ...
            echo '<div class="controls">';
                ...
                switch ($value['type']) {
                    case "text": ?>
                    <input class="form-control" type="text" name="custom_<?php echo isset($value['id']) ? $value['id'] : ''; ?>" value="<?php echo $custom_field_filter; ?>" />
                    <?php break;
                    case "picklist": ?>
                            <select id="custom_<?php echo isset($value['id']) ? $value['id'] : ''; ?>" class="form-control" name="custom_<?php echo $value['id']; ?>">
                    ...
                    <div class="input-append">
                        <input id="custom_<?php echo isset($value['id']) ? $value['id'] : ''; ?>" name="custom_<?php echo isset($value['id']) ? $value['id'] : ''; ?>_input" class="form-control filter_input date_input" type="text" value="<?php echo DateHelper::formatDate($custom_field_filter); ?>"  />
