        ...
        <ul class="unstyled">
            <li>
                <div class="goal_container media">
                    ...
                    <div class="goal_info_container media-body">
                        <h4><a href="<?php echo JRoute::_('index.php?view=goals&layout=edit&type=win_cash'); ?>"><?php echo ucwords(TextHelper::_('COBALT_WIN_MORE_CASH')); ?></a></h4>
            ...
            <li>
                <div class="goal_container media">
                    ...
                    <div class="goal_info_container media-body">
                        <h4><a href="<?php echo JRoute::_('index.php?view=goals&layout=edit&type=win_deals'); ?>"><?php echo ucwords(TextHelper::_('COBALT_WIN_MORE_DEALS')); ?></a></h4>
            ...
            <li>
                <div class="goal_container media">
                    ...
                    <div class="goal_info_container media-body">
                        <h4><a href="<?php echo JRoute::_('index.php?view=goals&layout=edit&type=move_deals'); ?>"><?php echo ucwords(TextHelper::_('COBALT_MOVE_DEALS_FORWARD')); ?></a></h4>
        ...
        <ul class="unstyled">
            <li>
                <div class="goal_container media">
                    ...
                    <div class="goal_info_container media-body">
                        <h4><a href="<?php echo JRoute::_('index.php?view=goals&layout=edit&type=complete_tasks'); ?>"><?php echo ucwords(TextHelper::_('COBALT_COMPLETE_TASKS')); ?></a></h4>
            ...
            <li>
                <div class="goal_container media">
                    ...
                    <div class="goal_info_container media-body">
                        <h4><a href="<?php echo JRoute::_('index.php?view=goals&layout=edit&type=write_notes'); ?>"><?php echo ucwords(TextHelper::_('COBALT_WRITE_NOTES')); ?></a></h4>
            ...
            <li>
                <div class="goal_container media">
                    ...
                    <div class="goal_info_container media-body">
                        <h4><a href="<?php echo JRoute::_('index.php?view=goals&layout=edit&type=create_deals'); ?>"><?php echo ucwords(TextHelper::_('COBALT_CREATE_DEALS')); ?></a></h4>
