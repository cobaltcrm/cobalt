...
<div class="page-header">
    <div class="btn-group pull-right">
        <a class="btn" href="javascript:void(0)" onclick="printItems(this)"><i class="icon-print"></i> <?php echo TextHelper::_('COBALT_PRINT'); ?></a>
        <?php if ( UsersHelper::canExport() ) {?>
            <a class="btn" href="javascript:void(0)" onclick="exportCsv()"><i class="icon-share"></i> <?php echo TextHelper::_('COBALT_EXPORT_CSV'); ?></a>
        <?php } ?>
    </div>
