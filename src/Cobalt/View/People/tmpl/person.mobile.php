...
<div data-role='content' data-theme='b'>
    <p><?php if ( array_key_exists('position',$person) ) { echo $person['position'] ? $person['position'].', '.TextHelper::_('COBALT_AT'): '' ; } ?>
    ...
    <div data-role="collapsible">
            <h3><?php echo TextHelper::_('COBALT_TASKS_AND_EVENTS'); ?></h3>
            <ul data-inset='true' data-role='listview' data-theme="c">
...
<?php // TODO: Format currency to local ?>
    <div data-role="collapsible">
            <h3><?php echo TextHelper::_('COBALT_EDIT_DEALS'); ?></h3>
            <ul data-inset='true' data-role='listview' data-theme="c">
                <?php
    ...
    <div data-role="collapsible">
        ...
        <div data-role="collapsible" data-collapsed="false">
        <h3><?php echo TextHelper::_('COBALT_CREATE_TASK'); ?></h3>
