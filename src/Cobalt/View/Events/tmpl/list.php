...
defined( '_CEXEC' ) or die( 'Restricted access' );
    ...
    for ($i=0; $i<$n; $i++) {
        ...
        echo '<tr id="list_row_'.$id.'" class="cobalt_row_'.$k.'">';
            ...
            echo '<td class="contacts" ><a href="javascript:void(0);" onclick="showEventContactsDialogModal('.$event['id'].');"><img src="'.JURI::base().'src/Cobalt/media/images/card.png'.'"/></a></td>';
            echo '<td class="notes"><a href="javascript:void(0);" onclick="openNoteModal(\''.$event['id'].'\',\'event\');"><img src="'.JURI::base().'src/Cobalt/media/images/notes.png'.'"/></a>';
