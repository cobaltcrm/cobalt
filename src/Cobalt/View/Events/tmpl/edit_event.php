    ...
    <div class="tab-content">
      <div class="tab-pane active fade in" id="Event">
            <div class="cobaltRow">
                ...
                <div class="cobaltValue"><input class="required form-control" type="text" name="name" value="<?php if ( array_key_exists('name',$event) ) echo $event['name']; ?>"/></div>
            </div>
      ...
      <div class="tab-pane fade" id="Date">
          <div class="cobaltRow">
            ...
            <div class="cobaltValue">
                        <input id="start_time" class="required form-control date_input" type="text" value="<?php if ( array_key_exists('start_time',$event) ) echo DateHelper::formatDate($event['start_time']); ?>" name="start_time_input" />
