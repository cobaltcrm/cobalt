...
<div class="step">
    <div class="title">
        <?php echo TextHelper::_('COBALT_STEP_ONE'); ?>
    </div>
    <div class="text">
        <h2><?php echo TextHelper::_('COBALT_EXPORT_YOUR_FILE'); ?></h2>
        <p><?php echo TextHelper::_('COBALT_EXPORT_YOUR_FILE_INSTRUCTIONS'); ?></p>
    </div>
</div>
<div class="step">
    <div class="title">
        <?php echo TextHelper::_('COBALT_STEP_TWO'); ?>
    </div>
    <div class="text">
        <h2><?php echo TextHelper::_('COBALT_ENSURE_YOUR_FILE_IS_FORMATTED'); ?></h2>
            <p><?php echo TextHelper::_('COBALT_ENSURE_YOUR_FILE_IS_FORMATTED_INSTRUCTIONS'); ?>
            <form id="download_import_template" method="post">
                <p><input class="button" onclick="downloadImportTemplate()" type="button" value="<?php echo TextHelper::_('COBALT_DOWNLOAD_TEMPLATE'); ?>" /></p>
...
<div class="step">
    <div class="title">
        <?php echo TextHelper::_('COBALT_STEP_THREE'); ?>
    </div>
    <div class="text">
