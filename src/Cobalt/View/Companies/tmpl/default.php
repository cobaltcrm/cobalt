...
<div class="page-header">
    <div class="btn-group pull-right">
        ...
        <a rel="tooltip" title="<?php echo TextHelper::_('COBALT_IMPORT_COMPANIES'); ?>" data-placement="bottom"  class="btn" href="<?php echo JRoute::_('index.php?view=import&import_type=companies'); ?>"><i class="icon-circle-arrow-up"></i></a>
        <?php if ( UsersHelper::canExport() ) { ?>
            <a rel="tooltip" title="<?php echo TextHelper::_('COBALT_EXPORT_COMPANIES'); ?>" data-placement="bottom" class="btn"href="javascript:void(0)" onclick="exportCsv()"><i class="icon-share"></i></a>
        <?php } ?>
    </div>
