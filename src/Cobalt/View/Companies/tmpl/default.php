...
<div class="page-header">
    <div class="box-layout">
        <div class="col-xs-5 col-sm-6 col-md-5 va-m"><h3><?php echo ucwords(TextHelper::_('COBALT_COMPANIES')); ?></h3></div>
        <div class="col-xs-7 col-sm-6 col-md-7 va-m">
            <div class="toolbar text-right" id="toolbar">
                <div class="btn-group">
                    <?php if ( UsersHelper::canExport() ): ?>
                    <button type="button" href="index.php?view=companies&layout=edit&format=raw&tmpl=component" data-target="#CobaltAjaxModal" data-toggle="modal" class="btn btn-default">
