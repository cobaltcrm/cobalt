...
class Pagination extends \JPagination
{
    ...
    public function getLimitBox()
    {
        ...
        $limits[] = JHtml::_('select.option', '50', TextHelper::_('J50'));
        $limits[] = JHtml::_('select.option', '100', TextHelper::_('J100'));
        $limits[] = JHtml::_('select.option', '0', TextHelper::_('JALL'));
    ...
    protected function _list_footer($list)
    {
        ...
        $html .= "\n<div class=\"limit pull-right\">" . TextHelper::_('JGLOBAL_DISPLAY_NUM') . $list['limitfield'] . "</div>";
