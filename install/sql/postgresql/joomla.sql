...
CREATE TYPE roletype AS ENUM ('exec','manager','basic');
...
CREATE TABLE "#__users" (
  ...
  "exports" smallint DEFAULT 0 NOT NULL,
  "can_delete" smallint DEFAULT 0 NOT NULL,
  "team_id" smallint DEFAULT 0 NOT NULL,
  ...
  "daily_agenda" smallint DEFAULT 0 NOT NULL,
  "morning_coffee" smallint DEFAULT 0 NOT NULL,
  "weekly_team_report" smallint DEFAULT 0 NOT NULL,
  "weekly_personal_report" smallint DEFAULT 0 NOT NULL,
  "reminder_notifications" smallint DEFAULT 0 NOT NULL,
  "sms_number" bigint DEFAULT 0 NOT NULL,
  "text_messages" smallint DEFAULT 0 NOT NULL,
  "home_page_chart" varchar(255) NULL,
  "commission_rate" bigint DEFAULT 0 NOT NULL,
  "deals_columns" text NULL,
  "people_columns" text NULL,
